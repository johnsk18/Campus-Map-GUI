...
public class CampusPathsTest { // Rename to the name of your "main" class
	...
	private void runTest(String filename) throws IOException {
		...
		String inFilename = "src/campus/data/"+filename+".test"; // Input filename: [filename].test here  
		String expectedFilename = "src/campus/data/"+filename+".expected"; // Expected result filename: [filename].expected
		String outFilename = "src/campus/data/"+filename+".out"; // Output filename: [filename].out
